        ...
        <div className={styles.containerPadre}>
            ...
            <div className={styles.containerPolitica}>
                <div className={styles.headerPolitica}>
                    <span className={styles.numero}>1</span><h3>Información que recopilamos</h3>
                </div>
            ...
            <div className={styles.containerPolitica}>
                <div className={styles.headerPolitica}>
                    <span className={styles.numero}>2</span><h3>Uso de la información</h3>
                </div>
            ...
            <div className={styles.containerPolitica}>
                <div className={styles.headerPolitica}>
                    <span className={styles.numero}>3</span><h3>Seguridad y actualización</h3>
                </div>
                <ul className={styles.lista}>
                    <div className={styles.politicaIzq}>
            ...
            <div className={styles.containerPolitica}>
                <div className={styles.headerPolitica}>
                    <span className={styles.numero}>4</span><h3>Derechos del usuario</h3>
                </div>
