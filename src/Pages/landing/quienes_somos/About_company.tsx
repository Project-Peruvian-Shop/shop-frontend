      ...
      <div className={styles.containerPadre}>
        ...
        <div className={styles.containerTexto}>
          <p>
            ...
            soluciones en tuberías de alta calidad, innovadoras y sostenibles,
            orientadas a satisfacer las necesidades de sectores clave como la
            construcción, el saneamiento y la industria. Somos una empresa{" "}
            <b>100% peruana, orgullosos de contribuir</b> al desarrollo del país
            y firmemente comprometidos con el cuidado del medio ambiente, así
            como con la promoción de prácticas responsables a lo largo de toda
            nuestra cadena de producción.
          </p>
          <p>
            Nuestros productos se fabrican mediante la{" "}
            <b>extrusión de compuestos de PVC</b>, un proceso eficiente y
            preciso que garantiza la calidad y resistencia de cada unidad.
            Utilizamos materiales de primera calidad, como estabilizantes de{" "}
            <b>Calcio/Zinc</b>, en sustitución de los metales pesados
            tradicionalmente empleados en la industria. Esta decisión no solo
            reduce el impacto ambiental de nuestros procesos, sino que también
            protege la salud de los trabajadores y usuarios finales, promoviendo
            una producción más limpia, segura y responsable.
          </p>
          <p>
            Este enfoque nos permite ofrecer{" "}
            <b>productos duraderos, confiables y de alto rendimiento</b>,
          ...
          <p>
            ...
            <b>infraestructuras eficientes y sostenibles</b> en las regiones
            norte y sur del país, reafirmando nuestro compromiso con la{" "}
            <b>calidad, la innovación, el servicio excepcional</b> y, sobre
            todo, con la{" "}
            <b>
